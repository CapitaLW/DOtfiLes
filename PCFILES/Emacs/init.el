...
;; Github Push for Loot
(defun my/git-auto-push ()
  "Automatically commit and push changes in ~/.emacs.d to GitHub."
  (when (string-prefix-p (expand-file-name "~/.emacs.d")
                         (or (buffer-file-name) ""))
    (let ((default-directory (expand-file-name "~/.emacs.d/")))
      (shell-command "git add -A")
      (shell-command "git commit -m 'Auto commit from Emacs' || true")
      (shell-command "git push origin main || true"))))

;; Automatically push when saving any file in ~/.emacs.d
(add-hook 'after-save-hook #'my/git-auto-push)
...
(custom-set-variables
 ...
 '(package-selected-packages
   '(all-the-icons dashboard lsp-ui magit mini-echo neotree nerd-icons
		   projectile python-mode rust-mode))
